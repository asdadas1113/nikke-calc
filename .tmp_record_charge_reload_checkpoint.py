...
checkpoint = Path('fast_engine/research/CHARGE_RELOAD_CANCEL_CONTROL_CHECKPOINT_20260905.md')
checkpoint.write_text('''# Fast Engine checkpoint — charge reload cancel-on-full — 2026-09-05
...
anchor = '2. `fast_engine/research/PATTERNLESS_SQUAD_PART_HIT_CHECKPOINT_20260905.md`\n'
assert anchor in text
text = text.replace(anchor, '2. `fast_engine/research/CHARGE_RELOAD_CANCEL_CONTROL_CHECKPOINT_20260905.md`\n3. `fast_engine/research/PATTERNLESS_SQUAD_PART_HIT_CHECKPOINT_20260905.md`\n', 1)
